    ...
    <View className="flex-1 bg-white" style={{ paddingTop: Math.max(insets.top, 20) }}>
      ...
      <View className="px-6 py-4 flex-row justify-between items-center mb-2">
        <View>
          ...
          <Text className="text-textPrimary text-3xl font-black mt-1">Teacher Portal</Text>
        </View>
        <TouchableOpacity 
      ...
      <ScrollView className="flex-1 px-5" showsVerticalScrollIndicator={false}>
        ...
        >
          <View className="flex-1">
            <Text className="text-white/80 text-sm font-bold uppercase tracking-wider mb-1">Upcoming</Text>
            <Text className="text-white text-xl font-bold">Class 5A - Math</Text>
          </View>
        ...
        <Text className="text-textPrimary text-xl font-bold mb-4 ml-1">Tools & Management</Text>
